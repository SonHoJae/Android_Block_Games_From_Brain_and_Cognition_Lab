...
public class Test_Block_Matcher_Letter_Activity extends Activity implements OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (selectCandidateNumber != null) {
            ...
            if (clickedTableBlock.getTag() == selectCandidateNumber) {
                numOfClickedBlock++;
                tableFunc.makeButtonCorrectImage((ImageButton)v,R.drawable.i);
...
//                    timerHandler.stopTimerReturnDuration();
                    ...
                    Intent intent = new Intent(this, Test_Block_Matcher_Letter_Activity.class);
