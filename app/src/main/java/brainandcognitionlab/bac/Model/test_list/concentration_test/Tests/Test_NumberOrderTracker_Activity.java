...
public class Test_NumberOrderTracker_Activity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_numberordertracker);
    ...
    public void onClick(View v) {
        ...
        if (isLeastNum) {
            ...
            if (orderCheckNumber == pickedSize) {
                ...
                Intent intent = new Intent(this, Test_NumberOrderTracker_Activity.class);
