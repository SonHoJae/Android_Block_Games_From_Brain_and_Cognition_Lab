...
public class Test_ReverseOrderTracker_Activity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_reverse_order_tracker);
    ...
    public void onClick(View v) {
        ...
        if (v.getTag() == pickedBlockNumbers[pickedSize -1 - orderCheckNumber]) {
            ...
            if (orderCheckNumber == pickedSize) {
                ...
                Intent intent = new Intent(this, Test_ReverseOrderTracker_Activity.class);
