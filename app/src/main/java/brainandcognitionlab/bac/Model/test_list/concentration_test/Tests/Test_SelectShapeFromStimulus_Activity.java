...
public class Test_SelectShapeFromStimulus_Activity extends Activity  {
...
//width and height of your Image ,if it is inside Relative change the LinearLayout to RelativeLayout.
    ...
    public void passATest(Context context, View v) {
        ...
        Intent intent = new Intent((Activity)context, Test_SelectShapeFromStimulus_Activity.class);
