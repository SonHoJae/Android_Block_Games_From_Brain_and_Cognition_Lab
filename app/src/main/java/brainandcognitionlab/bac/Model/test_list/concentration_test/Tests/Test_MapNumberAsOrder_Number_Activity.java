...
public class Test_MapNumberAsOrder_Number_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_map_number_as_order);
    ...
    public void onBlockTouchedActionPerform(View v) {
        ...
        if (clickedTableBlock.getTag() == randomValueArrayList.get(numOfClickedBlock)) {
            numOfClickedBlock++;
...
//                    timerHandler.stopTimerReturnDuration();
                ...
                Intent intent = new Intent(this, Test_MapNumberAsOrder_Number_Activity.class);
